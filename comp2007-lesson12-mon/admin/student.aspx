<%@ Page Title="Student Details" Language="C#" MasterPageFile="~/Monday.Master" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="comp2007_lesson12_mon.student" %>
    ...
    <asp:Panel ID="pnlCourses" runat="server" Visible="false">
        ...
        <asp:UpdatePanel ID="pnlGrid" runat="server" UpdateMode="Conditional">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="grdCourses" EventName="RowDeleting" />
            </Triggers>
        </asp:UpdatePanel>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="pnlCourse" runat="server">
                            <ContentTemplate>
